...
from banking.transactions.query.models.extraction import QueryExtractionResult, VarianceAnalysisExtraction
...
def _operation(
    *,
    ...
    if intent == QueryIntent.INSIGHT:
        ...
        return AnalyzeOperation(scope=scope, analysis=_variance_spec(insight, extraction, scope, today=today))
...
def _variance_spec(
    insight: VarianceAnalysisExtraction,
    extraction: QueryExtractionResult,
    scope: QueryScope,
    *,
    today: date,
