        ...
        QueryResultItem(
            ...
            metadata={
                **t,
                ...
                "local_status": t.get("local_status"),
                "bank_status": t.get("bank_status"),
                "unified_source": t.get("unified_source") or t.get("source"),
                "local_transaction_id": t.get("local_transaction_id"),
