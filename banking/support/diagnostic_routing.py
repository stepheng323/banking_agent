...
from banking.support.micro_resolver import NextStep
...
from banking.support.reference_selection import leg_to_candidate
...
class SupportDiagnosticRouter:
    ...
    def _support_capability_summary() -> dict[str, bool]:
        return {
            action.value: is_capability_supported(domain="support", action=action.value) for action in SupportAction
        }
