...
DATA_EXTRACTION_PROMPT = (
    ...
    "- selection_preference: 'most_data', 'cheapest', 'longest_validity', or 'best_value' "
    "when user asks for best/maximum value.\n"
    "- usage_intent: Usage context only, e.g. 'video_calls', 'social', 'browsing', 'night', 'weekend'. "
    "Do not invent plan facts.\n"
    ...
    'User: "2k, 08012345678, MTN"\n'
    'Output: {"schema_version":1,"intent":"data","intent_confidence":0.95,'
    '"entities":{"recipient_phone":"08012345678","network":"MTN","budget":2000.0,"size_preference":null,'
    '"validity_preference":null,"selection_preference":null,"usage_intent":null,"is_self":null,"recipient_name":null},'
    '"correction":null,"ambiguities":[],"references":{"use_recent_purchase":false},'
    '"requested_features":[]}\n\n'
    'User: "1GB, 08012345678"\n'
    'Output: {"schema_version":1,"intent":"data","intent_confidence":0.95,'
    '"entities":{"recipient_phone":"08012345678","network":null,"budget":null,"size_preference":"1GB",'
    '"validity_preference":null,"selection_preference":null,"usage_intent":null,"is_self":null,"recipient_name":null},'
    '"correction":null,"ambiguities":[],"references":{"use_recent_purchase":false},'
    '"requested_features":[]}\n\n'
    'User: "I meant 5k"\n'
