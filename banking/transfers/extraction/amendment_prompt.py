...
Set requires_broad_interpretation=true for scheduling/recurrence, batch or multi-recipient edits, mixed requests, image
interpretation, unsupported fields, or anything that needs broader orchestration. Acknowledgment is optional and under
eight words. Understand English, Nigerian Pidgin, Yoruba, Hausa, Igbo, French, and mixed wording semantically.
"""
