...
from apps.chat.src.agent.graphs.query.models.extraction import AmbiguityCode
from apps.chat.src.agent.graphs.query.prompts import QUERY_PARSER_PROMPT
from apps.chat.src.agent.graphs.query.services.resolver import Decision, Prompt, resolve
...
def build_pending_clarification(
    ...
    *,
    ...
    return PendingClarificationState(
        ...
        current_intent=parser._resolve_effective_intent(extraction),
...
def derive_requested_capabilities(
    ...
    *,
    ...
    inferred_transaction_type = parser._infer_transaction_type(
    ...
    from apps.chat.src.agent.graphs.query.models import QueryOperation
...
def inflate_parser_extraction(
    ...
    *,
    ...
    effective_intent = parser._resolve_effective_intent(inflated)
    inflated.query_operation = parser._infer_query_operation(inflated, effective_intent=effective_intent)
...
def validate_capabilities(extraction: QueryExtractionResult) -> None:
    from apps.chat.src.agent.graphs.query.models import RequestedCapability
