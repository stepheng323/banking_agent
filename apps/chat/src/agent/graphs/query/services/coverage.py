...
from apps.chat.src.agent.graphs.query.services.fetch import _is_missing_mirror_table_error
...
async def build_query_coverage_answer(
    *,
    ...
    snapshots = [
        await _coverage_for_account(account, start_date=start_date, end_date=end_date)
