...
from apps.chat.src.agent.graphs.query.continuations import extraction_paths
...
class ExtractionStep(QueryStep):
    ...
    async def _maybe_recover_supported_followup_query(
        ...
        *,
        ...
        return await extraction_paths.maybe_recover_supported_followup_query(
            self,
            state=state,
            today=today,
            language=language,
            has_original_scope=has_original_scope,
            reasoner_extraction=reasoner_extraction,
    ...
    async def _compile_aggregate_continuation_updates(
        ...
        *,
        ...
        return await extraction_paths.compile_aggregate_continuation_updates(
            self,
            decision=decision,
            state=state,
            today=today,
    ...
    async def _maybe_recover_time_rescope_continuation(
        ...
        *,
        ...
        return await extraction_paths.maybe_recover_time_rescope_continuation(
            self,
            trigger_reason=trigger_reason,
            decision=decision,
            state=state,
    ...
    async def _resolve_time_delta_range(
        ...
        *,
        ...
        return await extraction_paths.resolve_time_delta_range(
            self,
            decision=decision,
            message=message,
            today=today,
    ...
    def _resolve_grounded_followup(
        ...
        *,
        ...
        return extraction_paths.resolve_grounded_followup(
            self,
            decision=decision,
            session=session,
            language=language,
    ...
    async def _handle_pending_clarification(self, state: dict[str, Any], session: dict[str, Any]) -> dict[str, Any]:
        return await extraction_paths.handle_pending_clarification(self, state, session)
    ...
    async def _parse_new_query(self, state: dict[str, Any]) -> dict[str, Any]:
        return await extraction_paths.parse_new_query(self, state)
    ...
    async def _parse_reasoner_extraction_to_updates(
        ...
        *,
        ...
        return await extraction_paths.parse_reasoner_extraction_to_updates(
            self,
            decision,
            state=state,
            today=today,
    ...
    def _parse_result_to_updates(
        ...
        *,
        ...
        return extraction_paths.parse_result_to_updates(
            self,
            result,
            state=state,
            today=today,
