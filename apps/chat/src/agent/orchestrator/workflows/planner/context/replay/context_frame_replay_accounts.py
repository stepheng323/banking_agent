...
from apps.chat.src.agent.orchestrator.workflows.planner.context.replay.context_frame_replay_modifier_text import (
...
def _loaded_accounts_for_view(state_view: ContextFrameStateView) -> list[dict[str, Any]]:
    ...
    for account_source in account_sources:
        ...
        for account in account_source:
            ...
            account_number = str(account.get("account_number") or account.get("source_account_number") or "").strip()
