...
from apps.chat.src.agent.orchestrator.workflows.planner.context.summary.context_summary_active_flow import (
...
def build_turn_context_summary(
    ...
    *,
    ...
    return TurnContextSummary(
        ...
        short_term_memory_summary=ContextFrameManager().build_llm_summary(state) or None,
