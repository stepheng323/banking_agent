...
CLASSIFICATION_SYSTEM_PROMPT = (
    ...
    "INTENTS: transfer, airtime, data, query, support, mixed, manage_accounts, conversational, cancel, yes, no, confirm, skip, repeat_transaction, modify_transaction, unknown\n\n"
    "RULES:\n"
    ...
    "4. MANAGE_ACCOUNTS: account management ('Show accounts', 'How many accounts', 'Set default', 'Unlink account')\n"
