...
CLASSIFICATION_SYSTEM_PROMPT = (
    ...
    "5. MANAGE_ACCOUNTS: account management ('Show accounts', 'How many accounts', 'Set default', 'Unlink account'). NOTE: 'from my accounts' or 'from all my accounts' with 'send/transfer/pay' is TRANSFER, not manage_accounts\n"
    "5. TRANSFER: money transfers. Account numbers/bank names are continuations, not cancellations. 'Send X from my accounts' or 'from all accounts' = TRANSFER (multi-account pooling)\n"
    ...
    "- 'Send 40k from all my accounts to Jackson' → intent: transfer (multi-account pooling)\n"
    "- 'Send 100k using access and gtb' → intent: transfer (dual-account)\n"
