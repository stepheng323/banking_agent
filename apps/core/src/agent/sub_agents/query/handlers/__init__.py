...
from apps.core.src.agent.sub_agents.query.handlers.affordability import handle_affordability
from apps.core.src.agent.sub_agents.query.handlers.analytics import handle_analytics
from apps.core.src.agent.sub_agents.query.handlers.balance import handle_balance
from apps.core.src.agent.sub_agents.query.handlers.beneficiary import handle_beneficiary_summary
from apps.core.src.agent.sub_agents.query.handlers.time_comparison import handle_time_comparison
from apps.core.src.agent.sub_agents.query.handlers.transactions import (
