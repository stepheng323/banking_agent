...
def get_last4(account: Any, locale: str = "en") -> str:
    ...
    fallback_last4 = cast(str, render_message("source_account.list.last4_fallback", locale))
...
def format_accounts_list(accounts: list[Any] | None, locale: str = "en") -> str:
    ...
    if not accounts:
        return cast(str, render_message("source_account.no_accounts_found", locale))
...
def format_source_account_info_from_account_number(
    ...
    *,
    ...
    last4_fallback = cast(str, render_message("source_account.list.last4_fallback", locale))
